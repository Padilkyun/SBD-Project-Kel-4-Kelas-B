    ...
    <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Supply</h1>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="konek.php" method="POST" id="simpann" name="simpann">
                    <div class="mb-3">
                        <label for="pemasok" class="form-label">Pemasok</label>
                        <input type="text" class="form-control" id="pemasok" name="pemasok" value="<?php echo $pemasok; ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="col-12">
                        <input type="submit" name="simpann" value="Simpan Data" class="btn btn-primary" />
                    </div>
                </form>
            </div>
        </div>
